...
import { collection, doc, setDoc, updateDoc, orderBy } from "firebase/firestore";
...
const INITIAL_DEMO_COLLECTIONS: ManagerCollection[] = [
  {
    ...
    totalValueNgn: 945000, // (10*72000) + (5*45000)
    cashRemittedNgn: 684000, // (7*72000) + (4*45000)
    returnedStockValueNgn: 117000, // (1*72000) + (1*45000)
    remainingDebtValueNgn: 144000, // 945000 - 684000 - 117000
    status: "has_debt",
...
export function useManagerCollections() {
  ...
  const { data: firebaseData, loading: fbLoading } = useFirebaseCollection<ManagerCollection>(
    "managerCollections",
  ...
  const createCollection = useCallback(
    async (payload: Omit<ManagerCollection, "id" | "collectionNumber" | "createdAt" | "updatedAt" | "status" | "cashRemittedNgn" | "returnedStockValueNgn" | "remainingDebtValueNgn">) => {
