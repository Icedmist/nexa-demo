...
function MovementsPage() {
  ...
  const movementCsvColumns = useMemo<CSVColumn<StockMovement>[]>(() => [
    ...
    { header: "Total Value (NGN)", accessor: (m) => m.totalCostNgn ?? "" },
    { header: "Payment Made (NGN)", accessor: (m) => m.paymentAmountNgn ?? "" },
    { header: "Remaining Balance / Debt (NGN)", accessor: (m) => m.remainingBalanceNgn ?? "" },
    { header: "Payment Status", accessor: (m) => m.paymentStatus ?? "" },
